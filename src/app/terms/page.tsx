      ...
      <header className="px-4 md:px-8 bg-white w-full pb-8 md:pb-16 relative [background:linear-gradient(292deg,_#E0ECFE_0.55%,_#FCFDFF_99.45%)]">
        <div className="max-w-5xl mx-auto w-full px-4 md:px-0">
          <div className="flex flex-col items-start justify-center pt-52 pb-0">
            <h1 className="text-[#050506] text-3xl md:text-5xl font-bold mb-2 text-left">Terms of agreement</h1>
            <p className="text-[#737373] text-lg md:text-xl mb-2 lg:text-left">Last updated: 6th May 2024, 9:00pm</p>
          </div>
        </div>
      </header>
     ...
     <section className="w-full px-4 md:px-8 bg-[#F8F9FB]">
        ...
        <section className="flex-1">
          <div className="mb-8" id="info-collect">
            <h2 className="text-[#050506] text-2xl md:text-3xl font-semibold mb-2">1. Information We Collect</h2>
          ...
          <div className="mb-8" id="use-data">
            <h2 className="text-[#050506] text-2xl md:text-3xl font-semibold mb-2">2. How We Use Your Data</h2>
          ...
          <div className="mb-8" id="data-sharing">
            <h2 className="text-[#050506] text-2xl md:text-3xl font-semibold mb-2">3. Data Sharing</h2>
          ...
          <div className="mb-8" id="your-rights">
            <h2 className="text-[#050506] text-2xl md:text-3xl font-semibold mb-2">4. Your Rights</h2>
