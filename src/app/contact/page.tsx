    ...
    <div className="w-full min-h-screen bg-[#f8f9fb] font-satoshi pt-7 px-4 md:px-0 md:pt-0">
      ...
      <header className="bg-[#1a2238] w-full h-[783px] md:h-auto md:py-0 relative rounded-2xl md:rounded-none flex items-center md:block justify-center">
        <div className="flex flex-col items-center justify-center text-center md:pt-48 md:pb-16">
          <Image
            src={imgCustomerCareFill}
            alt="customer care"
            width={40}
            height={40}
            className="w-10 h-10 md:w-14 md:h-14 mx-auto mb-4"
            loading="lazy"
          />
          <h1 className="text-white text-[30px] md:text-5xl font-bold mb-4">
            Talk to us
          </h1>
          <p className="text-white text-[16px] md:text-2xl font-[300] max-w-2xl lg:max-w-4xl mx-auto">
          ...
          <div className="flex-1 flex flex-col gap-10 min-w-[300px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-4 ">
                ...
                <div>
                  <div className="text-[#050506] text-lg font-[500] md:font-semibold">
                    Call Us
                  </div>
                  <div className="text-[#393939] text-base">
              ...
              <div className="flex items-start gap-4 ">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    <span className="text-[#213879] text-xs underline cursor-pointer">
                      Chat with us
                    </span>
                    <Image
                      src={imgArrowRightLine}
                      alt="arrow"
                      width={14}
                      height={14}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-[#393939] text-base">
                    support@veloxpayments.com
                  </div>
                  <div className="text-[#393939] text-xs">
                    Reply within 36 hours
                  </div>
                </div>
              </div>
              {/* Socials */}
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-[#050506] text-lg font-[500] md:font-semibold mb-1">
                    Our socials
                  </div>
