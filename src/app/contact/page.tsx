    ...
    <div className="w-full min-h-screen bg-[#f8f9fb] font-satoshi">
      ...
      <header className="bg-[#1a2238] w-full pb-12 md:pb-0 relative">
        <div className="flex flex-col items-center justify-center text-center pt-16 md:pt-48 pb-8 md:pb-16">
          <img src={imgCustomerCareFill} alt="customer care" className="w-14 h-14 mx-auto mb-4" />
          <h1 className="text-white text-4xl md:text-5xl font-bold mb-4">Talk to us</h1>
          <p className="text-white text-xl md:text-2xl font-[300] max-w-2xl lg:max-w-4xl mx-auto">Get in touch, we are here to help</p>
        </div>
      </header>

      {/* Contact Section */}
      <section className="w-full relative custom-bg-faq py-16 md:py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-start justify-center relative z-10 px-4">
          ...
          <div className="flex-1 flex flex-col gap-10 min-w-[300px]">
            <h2 className="text-[#050506] text-3xl md:text-4xl font-bold max-w-lg">We are always ready to help you and answer your questions</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-4 ">
                ...
                <div>
                  <div className="text-[#050506] text-lg font-semibold">Call Us</div>
              ...
              <div className="flex items-start gap-4 ">
                ...
                <div>
                  <div className="text-[#050506] text-lg font-semibold">Live chat</div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-[#050506] text-lg font-semibold">Email</div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-[#050506] text-lg font-semibold mb-1">Our socials</div>
