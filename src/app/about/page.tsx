    ...
    <div className="w-full bg-[#f7f8fa] flex flex-col items-center pt-7 md:px-0 md:pt-0">
      ...
      <section className="w-full bg-[#fefdf6] py-12 md:py-20 flex flex-col items-center px-4">
        <div className="max-w-6xl md:max-w-full w-full flex flex-col items-center">
          ...
          <Image src={blueLine} alt="underline" width={98} height={8} className="w-[98px] h-2 mt-2" loading="lazy" />
          <p className="text-[#1f1f1f] text-[16px] md:text-[24px] text-center mt-4">
            Meet the experienced leaders driving our vision and mission forward.
          </p>
          ...
          {(() => {
            const leaders = [
              {
                name: "Paul Adebayo",
                title: "Captain of Chaos",
                img: headshot,
              },
              {
                name: "Abdulrahman Atta",
                title: "Chief Technical Officer",
                img: headshot,
              },
              {
                name: "Tolulope Eweniyi",
                  ...
                  {leaders.slice(0, 5).map((leader, idx) => (
                    ...
                    >
                      <Image
                        ...
                        loading="lazy"
                      />
                      <h3 className="text-[14px] font-medium text-[#000] text-center leading-tight">
                        {leader.name}
                      </h3>
                      <p className="text-[12px] text-neutral-500 text-center leading-tight">
                        {leader.title}
                      </p>
                    </div>
                  ))}
                ...
                <div className="hidden md:flex relative w-full md:max-w-[90vw] mt-10 flex-col items-center">
                  ...
                  >
                    {leaders.map((leader, idx) => (
                      ...
                      >
                        <div
                          className="w-[180px] h-[180px] md:w-[296px] md:h-[340px] rounded-2xl bg-cover bg-center"
                          style={{ backgroundImage: `url(${leader.img})` }}
                        />
                        <h3 className="text-[18px] md:text-[24px] font-medium text-[#000] mt-4">
                          {leader.name}
                        </h3>
                        <p className="text-[14px] md:text-[18px] text-neutral-500">
                          {leader.title}
                        </p>
                      </div>
                    ))}
